...
## Wither Turret Kit
# If result item is in output, but not a full stack
execute if data block ~ ~1 ~ Items[{Slot:0b,id:"minecraft:wither_rose"}] if data block ~ ~1 ~ Items[{Slot:1b,id:"minecraft:blaze_rod",tag:{display:{Name:"{\"text\":\"Status Turret Core\",\"color\":\"light_purple\"}"},Enchantments:[{id:"minecraft:infinity",lvl:1}],HideFlags:39}}] if data block ~ ~1 ~ Items[{Slot:2b,id:"minecraft:blaze_rod",tag:{display:{Name:"{\"text\":\"Wither Turret Kit\",\"color\":\"dark_gray\"}"},Enchantments:[{id:"minecraft:infinity",lvl:1}],HideFlags:39}}] unless data block ~ ~1 ~ Items[{Slot:2b,Count:64b}] run function team_battle_pack:defense/crafting/wither_turret
# If no item is in output
