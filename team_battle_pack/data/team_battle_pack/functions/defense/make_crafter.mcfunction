...
# Team
scoreboard players operation @e[type=armor_stand,tag=new_def_crafter,distance=..1.65,limit=1] tbp_team = @e[type=end_crystal,tag=nexus,distance=..100,limit=1] tbp_team
# Color
