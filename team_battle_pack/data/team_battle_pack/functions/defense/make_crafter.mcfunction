...
# Team
scoreboard players operation @e[type=armor_stand,tag=new_def_crafter,distance=..4,limit=1] tbp_team = @e[type=end_crystal,tag=nexus,distance=..100,limit=1] tbp_team
# Color
scoreboard players operation @e[type=armor_stand,tag=new_def_crafter,distance=..4,limit=1] tbp_color = @e[type=end_crystal,tag=nexus,distance=..100,limit=1] tbp_color

## Tag the armor stand
tag @e[type=armor_stand,tag=new_def_crafter,distance=..4,limit=1] remove new_def_crafter
