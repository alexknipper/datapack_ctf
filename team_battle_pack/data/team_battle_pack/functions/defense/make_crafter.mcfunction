...
execute at @e[type=minecraft:item_frame,distance=..1.25,limit=1,sort=nearest] run summon minecraft:armor_stand ~ ~-2.5 ~ {Invisible:1b,NoGravity:1b,Invulnerable:1b,ArmorItems:[{},{},{},{id:enchanting_table,Count:1b}],DisabledSlots:5039583}
...
## Tag the armor stand
tag @e[type=armor_stand,distance=..1.65,limit=1] add def_crafter
