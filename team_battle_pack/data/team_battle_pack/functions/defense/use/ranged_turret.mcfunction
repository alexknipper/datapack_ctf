...
# Team
execute as @e[type=minecraft:end_crystal,tag=nexus,distance=..100,limit=1] run scoreboard players operation @e[type=minecraft:armor_stand,tag=ranged_turret,distance=..1.65,limit=1,sort=nearest] tbp_team = @s tbp_team
# Color
execute as @e[type=minecraft:end_crystal,tag=nexus,distance=..100,limit=1] run scoreboard players operation @e[type=minecraft:armor_stand,tag=ranged_turret,distance=..1.65,limit=1,sort=nearest] tbp_color = @s tbp_color



## Store the turret's current coordinates in a scoreboard
execute as @e[type=minecraft:armor_stand,tag=ranged_turret,distance=..1.65,limit=1,sort=nearest] store result score @s tbp_ranged_x run data get entity @s Pos[0]
execute as @e[type=minecraft:armor_stand,tag=ranged_turret,distance=..1.65,limit=1,sort=nearest] store result score @s tbp_ranged_y run data get entity @s Pos[1]
execute as @e[type=minecraft:armor_stand,tag=ranged_turret,distance=..1.65,limit=1,sort=nearest] store result score @s tbp_ranged_z run data get entity @s Pos[2]
