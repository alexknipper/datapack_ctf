...
execute as @s[tag=ranged_turret,tag=!upgraded] if entity @a[tag=enemy,distance=..25,limit=1,sort=nearest] run summon minecraft:arrow ^ ^2 ^1.65 {Motion:[0.0,0.0,0.0],Tags:["ranged_projectile"]}
execute as @s[tag=ranged_turret,tag=!upgraded] if entity @a[tag=enemy,distance=..25,limit=1,sort=nearest] as @e[type=minecraft:arrow,tag=ranged_projectile,distance=1.6..1.7,limit=1,sort=nearest] run function team_battle_pack:defense/effects/projectile_motion
...
execute as @s[tag=ranged_turret,tag=upgraded] if entity @a[tag=enemy,distance=..25,limit=1,sort=nearest] as @e[type=minecraft:fireball,tag=ranged_projectile,distance=1.6..1.7,limit=1,sort=nearest] run function team_battle_pack:defense/effects/projectile_motion
