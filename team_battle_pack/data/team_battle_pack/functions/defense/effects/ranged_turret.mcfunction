...
execute as @s[tag=ranged_turret,tag=!upgraded] if entity @a[tag=enemy,distance=..25,limit=1,sort=nearest] as @e[type=minecraft:arrow,tag=ranged_projectile,distance=1..2.5,limit=1,sort=nearest] run function team_battle_pack:defense/effects/projectile_motion
# If the turret is upgraded, spawn a fireball & give it the appropriate motion
execute as @s[tag=ranged_turret,tag=upgraded] if entity @a[tag=enemy,distance=..25,limit=1,sort=nearest] anchored eyes run summon minecraft:fireball ^ ^ ^1.65 {ExplosionPower:0,direction:[0.0,0.0,0.0],Tags:["ranged_projectile"]}
execute as @s[tag=ranged_turret,tag=upgraded] if entity @a[tag=enemy,distance=..25,limit=1,sort=nearest] as @e[type=minecraft:fireball,tag=ranged_projectile,distance=1..2.5,limit=1,sort=nearest] run function team_battle_pack:defense/effects/projectile_motion
