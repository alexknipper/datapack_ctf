...
execute as @s[tag=ranged_turret,tag=upgraded] if entity @a[tag=enemy,distance=..25,limit=1,sort=nearest] as @e[type=minecraft:fireball,tag=ranged_projectile,distance=..4,limit=1,sort=nearest] run function team_battle_pack:defense/effects/projectile_motion
