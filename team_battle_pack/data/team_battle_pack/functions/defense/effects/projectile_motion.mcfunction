...
execute store result entity @s[type=minecraft:fireball] direction[0] double .5 run scoreboard players get @e[type=minecraft:armor_stand,tag=ranged_turret,distance=..1,limit=1] tbp_ranged_dx
execute store result entity @s[type=minecraft:fireball] direction[1] double .5 run scoreboard players get @e[type=minecraft:armor_stand,tag=ranged_turret,distance=..1,limit=1] tbp_ranged_dy
execute store result entity @s[type=minecraft:fireball] direction[2] double .5 run scoreboard players get @e[type=minecraft:armor_stand,tag=ranged_turret,distance=..1,limit=1] tbp_ranged_dz