...
execute store result entity @s[type=minecraft:arrow] Motion[0] double .125 run scoreboard players get @e[type=minecraft:armor_stand,tag=ranged_turret,distance=..1,limit=1] tbp_ranged_dx
execute store result entity @s[type=minecraft:arrow] Motion[1] double .125 run scoreboard players get @e[type=minecraft:armor_stand,tag=ranged_turret,distance=..1,limit=1] tbp_ranged_dy
execute store result entity @s[type=minecraft:arrow] Motion[2] double .125 run scoreboard players get @e[type=minecraft:armor_stand,tag=ranged_turret,distance=..1,limit=1] tbp_ranged_dz
