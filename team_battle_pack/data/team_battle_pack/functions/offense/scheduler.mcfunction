...
## Item Use
execute as @a[scores={tbp_firestar_use=1..}] at @s anchored eyes at @e[type=minecraft:item,nbt={Item:{id:"minecraft:firework_star",tag:{HideFlags:39,Enchantments:[{id:"minecraft:infinity",lvl:1}]}}},distance=1..5,limit=1,sort=nearest] run function team_battle_pack:offense/use_items
