...
execute at @s run summon minecraft:armor_stand ~ ~-.25 ~ {CustomName:"{\"text\":\"Cores Captured: \"}",Invisible:1b,NoGravity:1b,Invulnerable:1b,CustomNameVisible:1b,Tags:["capture_indicator"]}
