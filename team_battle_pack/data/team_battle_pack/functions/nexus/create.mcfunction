...
execute at @s at @e[type=minecraft:armor_stand,distance=1..2,limit=1,sort=nearest] run summon minecraft:armor_stand ~ ~-2 ~ {CustomName:"{\"text\":\"Cores Captured: 0\"}",Invisible:1b,NoGravity:1b,Invulnerable:1b,CustomNameVisible:1b,Tags:["capture_indicator"]}
